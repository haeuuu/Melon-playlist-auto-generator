...
class BuildPlaylist:
    ...
    def login(self,uid',password):
        ...
        melon_login_xpath = '//*[@id="conts_section"]/div/div/div[3]/button/span'
...
if __name__ == '__main__':
    play_list = ['내적 댄스를 유발하는 그루브한 노래들', 'selfish Jeremy Zucker', 'Good Daze (Feat. Shanin Blake) Jazzinuf']
    ply_generater = BuildPlaylist()
    ply_generater.login(your_id, password)
    ply_generater.run(play_list)
    ply_generater.quit()
